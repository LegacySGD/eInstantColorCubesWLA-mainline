//package com.igt.gle.game.paytable.EInstantTemplate;
...
public class ColorCubesWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ColorCubesWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ColorCubesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ColorCubesWLAIW/InitOutcome.xml").getDocumentElement();
